            ...
            <div class="ps-cart-listing">
                <table class="table ps-cart__table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a class="ps-product__preview" href="{{route('product.show',$item->product->slug)}}"><img class="mr-15" width="50" src="{{$item->product->image_url}}" alt=""> {{$item->product->name}}</a></td>
