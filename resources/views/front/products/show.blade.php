            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                    ...
                    <div class="ps-product__thumbnail--mobile">
                        ...
                        <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="20" data-owl-nav="true" data-owl-dots="false" data-owl-item="3" data-owl-item-xs="3" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on"><img src="{{$product->image_url}}" alt=""><img src="images/shoe-detail/2.jpg" alt=""><img src="images/shoe-detail/3.jpg" alt=""></div>
                    </div>
                    <div class="ps-product__info">
                        ...
                        <div class="ps-product__block ps-product__style">
                            ...
                            <ul>
                            @foreach($product->images as $image)
                                <li><a href="product-detail.html"><img src="{{$image->image_url}}" alt=""></a></li>
                               @endforeach 
                            </ul>
                        </div>
