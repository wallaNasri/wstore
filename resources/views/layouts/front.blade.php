        ...
        <div class="container-fluid">
          <div class="row">
                ...
                <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                  ...
                  <div class="header__actions"><a href="{{route('register')}}">Regiser</a>
              ...
              <div class="ps-cart__listing">
                ...
                @foreach($cart as $item)
                  ...
                  <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                    <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="{{$item->product->image_url}}" alt=""></div>
                    <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">{{$item->product->name}}</a>
                      <p><span>Quantity:<i>{{$item->quantity}}</i></span><span>Total:<i>£{{$item->total}}</i></span></p>
                    </div>
                  </div>
                  @endforeach
                </div>
        ...
        <div class="ps-container">
          <div class="row">
                ...
                <div class="col-lg-5 col-md-7 col-sm-12 col-xs-12 ">
                  <form class="ps-subscribe__form" action="{{route('register')}}" method="get">
                    @csrf
